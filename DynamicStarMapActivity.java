...
import com.google.android.stardroid.layers.CameraController;
...
public class DynamicStarMapActivity extends InjectableActivity
  ...
  private void updateCameraPreviewVisibility() {
    FrameLayout cameraView = findViewById(R.id.camera_view_container);
    if (CameraController.INSTANCE.getShowCamera()) {
  ...
  private void startCameraPreview() {
    FrameLayout container = findViewById(R.id.camera_view_container);
    container.removeAllViews();

    TextView tv = new TextView(this);
    tv.setText("📷 Camera is ON");
    tv.setTextSize(24f);
